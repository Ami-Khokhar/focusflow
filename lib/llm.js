...
export async function streamChatResponse({
    ...
    return streamGeminiResponse({ systemPrompt, conversationHistory, onToken });
}

// ─── Gemini production streaming ───

async function streamGeminiResponse({ systemPrompt, conversationHistory, onToken }) {
    ...
    const contents = raw.slice(startIdx);
